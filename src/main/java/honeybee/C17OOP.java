...
public class C17OOP {
        ...
        public static void main(String[] args) {
            ...
            unit.attack();
            unit.move();
            // scv2.collect(); // 사용불가 - Unit3Action에 정의를 안함
            ...
            // 다른 타입으로 변경 불가
            // ex)scv(에씨비 타입) = new Marine3(); (마린 타입)
...
class SCV3 extends Unit3 implements Unit3Action{
    ...
    protected void collect() {
        System.out.println("미네랄이나 베스핀 가스를 캐는중...");
    }
...
class Firebat3 extends Unit2 implements Unit3Action{
    public Firebat3() {
...
class Medic3 extends Unit2 implements Unit3Action {
    public Medic3() {
